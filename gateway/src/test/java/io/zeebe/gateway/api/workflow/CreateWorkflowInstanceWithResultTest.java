...
public class CreateWorkflowInstanceWithResultTest extends GatewayTest {
  ...
  public void shouldMapToBrokerRequest() {
    ...
    assertThat(brokerRequest.getValueType())
        .isEqualTo(ValueType.WORKFLOW_INSTANCE_CREATION_WITH_RESULT);

    final WorkflowInstanceCreationWithResultRecord brokerRequestValue =
        brokerRequest.getRequestWriter();
